...
@lru_cache
def get_tokenizer(model_name, use_fast: bool = True):  # model_name: clip
    """
    ...
    local_path = "/data/duweihong/huggingface/clip/clip-vit-base-patch16"
    tokenizer = AutoTokenizer.from_pretrained(
        local_path, use_fast=use_fast
    )  # openai/clip-vit-base-patch16
